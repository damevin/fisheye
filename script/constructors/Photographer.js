class Photographer {
    ...
    /**
     * @description Create and return user card 
     * @returns {string}
     */
    get userCard() {
        return `
       ...
       return `
            <div class="photographer-page__header">
                ...
                <button 
                    ...
                    class="photographer-page__contact__button focus__element-secondary" 
                    onclick="displayPhotographerModale()" 
                    tabindex="3" 
                >
                    Contactez-moi
                </button>
    ...
    /**
     * Create and return photographer footer on his page
     * @returns {string}
     */
    get userFooter() {
        return `
